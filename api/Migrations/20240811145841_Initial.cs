        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsPurchasePaid = table.Column<bool>(type: "bit", nullable: false),
                    DatePurchasePaid = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SpecificationItems", x => new { x.SpecificationId, x.ItemId });
                    table.ForeignKey(
                        name: "FK_SpecificationItems_Items_ItemId",
                        column: x => x.ItemId,
                        principalTable: "Items",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 9, "Screen size" },
                    { 10, "Hard disk size" },
                    { 11, "RAM memory installed size" },
                    { 12, "Operating system" },
                    { 13, "Graphics card description" },
                    { 14, "Maximum display resolution" },
                    { 15, "CPU speed" },
                    { 16, "Shape" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SpecificationItems_ItemId",
