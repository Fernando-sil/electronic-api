...
namespace api.Migrations
{
    ...
    [Migration("20240816223531_OnSaleItemToItem")]
    partial class OnSaleItemToItem
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("api.Entities.OnSaleItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("api.Entities.OnSaleItem", b =>
                {
                    b.HasOne("api.Entities.Item", "Item")
                        .WithOne("OnSaleItem")
                        .HasForeignKey("api.Entities.OnSaleItem", "ItemId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
